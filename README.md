...
sh /tmp/install-arg-bridge.sh --version 1.5.5
...
npm install -g --ignore-scripts --install-links=true \
  "git+https://github.com/Arginine-Arg/Feishu_bridge_arg.git#v1.5.5"
```
