...
Version 1.4.0 adds dynamic tmux pane discovery for the opt-in structured API backend. The existing terminal backend remains the default. See [configuration, validated capabilities, and limitations](./docs/structured-backend.md) before enabling it. Updating does not migrate existing terminal sessions.
...
sh /tmp/install-arg-bridge.sh --version 1.4.0
