...
sh /tmp/install-arg-bridge.sh --version 1.1.1
...
| `/btw <text>` | Codex only: open or reuse a side conversation, then submit the text as a separate prompt. `/codex /btw <text>` is equivalent. |
